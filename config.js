...
global.sudo = process.env.SUDO || '201286687614'
global.devs = '201286687614';
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? '𝐈𝐓𝐀𝐂𝐇𝐈 👑' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝐈𝐓𝐀𝐂𝐇𝐈 👑' : process.env.PACK_INFO.split(";")[1],
